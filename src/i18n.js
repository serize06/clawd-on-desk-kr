...
const i18n = {
  ...
  ko: {
    ...
    proportionalCustomTitle: "커스텀 비율",
    proportionalCustomMsg: "화면 너비 비율을 입력하세요 (1–75):",
    sendToDisplay: "디스플레이로 보내기",
    displayLabel: "디스플레이 {n}",
    displayLabelPrimary: "디스플레이 {n} (기본)",
    displayResolution: "{w}×{h}",
    miniMode: "미니 모드",
    ...
    updateAvailableMsg: "v{version}이 나왔어요. 지금 다운로드 후 설치할까요?",
    updateAvailableMacMsg: "v{version}이 나왔어요. 다운로드 페이지 열까요?",
    updateNotAvailable: "최신 버전",
    updateNotAvailableMsg: "Clawd v{version}이 최신입니다.",
    updateDownloading: "업데이트 다운로드 중…",
    updateReady: "업데이트 준비 완료",
    updateReadyMsg: "v{version} 다운로드 끝. 지금 재시작할까요?",
    updateError: "업데이트 오류",
    updateErrorMsg: "업데이트 확인 실패. 잠시 후 다시 시도.",
    updateDirtyMsg: "로컬 파일에 수정사항이 있어요. commit/stash 후 업데이트해주세요.",
    updateNow: "지금 업데이트",
    updating: "업데이트 중…",
    gitUpdateRestarting: "업데이트 완료. Clawd 재시작 중…",
    macUpdateOpened: "브라우저에서 최신 다운로드 페이지 열었습니다.",
    restartNow: "지금 재시작",
    restartLater: "나중에",
    download: "다운로드",
    dismiss: "닫기",
    bubbleFollow: "말풍선이 Clawd 따라가기",
    hideBubbles: "말풍선 숨기기",
    ...
    settings: "설정…",
    toggleShortcut: "토글 단축키: {shortcut}",
    quit: "종료",
  },
};
